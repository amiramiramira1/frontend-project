...
const seed = async () => {
  try {
    ...
    const [
      ...
      uploadImage('https://images.unsplash.com/photo-1560684352-8497838a2229?w=800', 'meal_moussaka'),
      uploadImage('https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800', 'meal_falafel'),
      uploadImage('https://images.unsplash.com/photo-1511690656952-34342bb7c2f2?w=800', 'meal_mahshi'),
      uploadImage('https://images.unsplash.com/photo-1547592180-85f173990554?w=800', 'meal_lentilsoup'),
      uploadImage('https://images.unsplash.com/photo-1534604973900-c43ab4c2e0ab?w=800', 'meal_sayadeya'),
      uploadImage('https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=800', 'meal_shrimp'),
      ...
      uploadImage('https://images.unsplash.com/photo-1608039829572-78524f79c4c7?w=800', 'meal_shakshuka'),
      ...
      uploadImage('https://images.unsplash.com/photo-1544025162-d76694265947?w=800', 'box_mazag'),
      uploadImage('https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?w=800', 'box_fetaar'),
      uploadImage('https://images.unsplash.com/photo-1608897013039-887f21d8c804?w=800', 'box_mosta3gelen'),
      uploadImage('https://images.unsplash.com/photo-1567620832903-9fc6debc209f?w=800', 'box_layaly'),
      uploadImage('https://images.unsplash.com/photo-1534604973900-c43ab4c2e0ab?w=800', 'box_wa7sh'),
      uploadImage('https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=800', 'box_dietbas')
    ]);
    ...
    const ingredients = await Ingredient.insertMany([
      { name: 'Chicken Breast', unit: 'g',     costPerUnit: 0.25,  caloriesPerUnit: 1.65, stockQuantity: 100000 },
      { name: 'Basmati Rice',   unit: 'g',     costPerUnit: 0.05,  caloriesPerUnit: 1.30, stockQuantity: 150000 },
      { name: 'Broccoli',       unit: 'g',     costPerUnit: 0.04,  caloriesPerUnit: 0.34, stockQuantity: 80000 },
      { name: 'Olive Oil',      unit: 'ml',    costPerUnit: 0.15,  caloriesPerUnit: 8.84, stockQuantity: 50000 },
      { name: 'Pasta',          unit: 'g',     costPerUnit: 0.04,  caloriesPerUnit: 1.31, stockQuantity: 100000 },
      { name: 'Tomato Sauce',   unit: 'ml',    costPerUnit: 0.06,  caloriesPerUnit: 0.29, stockQuantity: 100000 },
      { name: 'Cheddar Cheese', unit: 'g',     costPerUnit: 0.35,  caloriesPerUnit: 4.02, stockQuantity: 30000 },
      { name: 'Eggs',           unit: 'piece', costPerUnit: 5.50,  caloriesPerUnit: 78,   stockQuantity: 10000 },
      { name: 'Spinach',        unit: 'g',     costPerUnit: 0.08,  caloriesPerUnit: 0.23, stockQuantity: 50000 },
      { name: 'Salmon Fillet',  unit: 'g',     costPerUnit: 1.25,  caloriesPerUnit: 2.08, stockQuantity: 40000 },
      { name: 'Lentils',        unit: 'g',     costPerUnit: 0.06,  caloriesPerUnit: 1.16, stockQuantity: 120000 },
      { name: 'Macaroni',       unit: 'g',     costPerUnit: 0.04,  caloriesPerUnit: 3.71, stockQuantity: 100000 },
      { name: 'Chickpeas',      unit: 'g',     costPerUnit: 0.08,  caloriesPerUnit: 3.64, stockQuantity: 80000 },
      { name: 'Eggplant',       unit: 'g',     costPerUnit: 0.03,  caloriesPerUnit: 0.25, stockQuantity: 90000 },
      { name: 'Minced Beef',    unit: 'g',     costPerUnit: 0.35,  caloriesPerUnit: 2.50, stockQuantity: 80000 },
      { name: 'Fava Beans',     unit: 'g',     costPerUnit: 0.05,  caloriesPerUnit: 3.41, stockQuantity: 150000 },
      { name: 'Zucchini',       unit: 'g',     costPerUnit: 0.04,  caloriesPerUnit: 0.17, stockQuantity: 100000 },
      { name: 'Sea Bass Fillet',unit: 'g',     costPerUnit: 0.95,  caloriesPerUnit: 0.97, stockQuantity: 30000 },
      { name: 'Okra',           unit: 'g',     costPerUnit: 0.06,  caloriesPerUnit: 0.33, stockQuantity: 60000 },
      { name: 'Tender Lamb',    unit: 'g',     costPerUnit: 0.45,  caloriesPerUnit: 2.94, stockQuantity: 40000 },
    ]);
    ...
    const boxes = await Box.insertMany([
      ...
      {
        name: 'صاحب مزاج (Sa7eb Mazag Gourmet Box)',
        description: 'طواجن ومشاوي ثقيلة معمولة بمزاج عالي ولغة تانية خالص لأصحاب الكيف والأكل الحرش: بامية باللحم الضاني وكفتة مشوية وسمك صيادية. (Claypots and charcoal grills made with high passion for gourmet food lovers: Lamb Okra, Charcoal Grilled Kofta, and Sayadeya Baked Fish.)',
        type: 'pre-made', dietType: 'standard',
        meals: [meals[11]._id, meals[9]._id, meals[6]._id],
        basePrice: calcBoxPrice([meals[11], meals[9], meals[6]]),
        image: imgMazagBox, isActive: true,
      },
      {
        name: 'فطار وعشا (Fetaar & 3asha Box)',
        description: 'أحلى فطور مصري بلدي خفيف ومغذي يسندك طول اليوم أو ينفعك في عشا دافي: شكشوكة وفول وطعمية وشوربة عدس دافية. (Perfect light, nourishing traditional Egyptian breakfast or warm comforting dinner: Shakshuka, Falafel, Ful, and Lentil Soup.)',
        type: 'pre-made', dietType: 'vegetarian',
        meals: [meals[13]._id, meals[3]._id, meals[5]._id],
        basePrice: calcBoxPrice([meals[13], meals[3], meals[5]]),
        image: imgFetaarBox, isActive: true,
      },
      {
        name: 'أكلة المستعجلين (Aklet El Mosta3gelen Box)',
        description: 'وجبات سريعة وخفيفة ولذيذة جاهزة في ثواني ومثالية للأيام المزدحمة: شاورما فراخ ودجاج تكا ومكرونة كرات اللحم. (Quick and delicious high-energy meals prepared in seconds, ideal for busy days: Chicken Shawarma, Chicken Tikka, and Spaghetti & Meatballs.)',
        type: 'pre-made', dietType: 'standard',
        meals: [meals[12]._id, meals[14]._id, meals[15]._id],
        basePrice: calcBoxPrice([meals[12], meals[14], meals[15]]),
        image: imgMosta3gelenBox, isActive: true,
      },
      {
        name: 'ليالي زمان (Layaly Zaman Classic Box)',
        description: 'أطباق كلاسيكية أصيلة تفكرك بلمة العيلة وأيام زمان وأحلى طبخ بيتي: كشري وملوخية ومحشي كوسة. (Classic authentic home-cooked favorites that bring back sweet family memories: Koshari, Molokhia, and stuffed Mahshi Zucchini.)',
        type: 'pre-made', dietType: 'standard',
        meals: [meals[0]._id, meals[1]._id, meals[4]._id],
        basePrice: calcBoxPrice([meals[0], meals[1], meals[4]]),
        image: imgLayalyBox, isActive: true,
      },
      {
        name: 'وحش الفوسفور (Wa7sh El Phosphor Power Box)',
        description: 'طاقة وفسفور وبروتين عالي ميكس بين السمك الفريش واللحمة المشوية المتبلة: جمبري بالزبدة والثوم وسلمون مشوي وكفتة مشوية. (High energy, protein, and sea-phosphorus mix of fresh seafood and charcoal-grilled meat: Butter Garlic Shrimp, Seared Salmon, and Grilled Kofta.)',
        type: 'pre-made', dietType: 'keto',
        meals: [meals[7]._id, meals[8]._id, meals[9]._id],
        basePrice: calcBoxPrice([meals[7], meals[8], meals[9]]),
        image: imgWa7shBox, isActive: true,
      },
      {
        name: 'دايت وبس (Diet we Bas Healthy Box)',
        description: 'خيارات نظيفة ورياضية عالية البروتين وقليلة الدهون مخصصة للنشاط واللياقة: سلطة شيش طاووق ودجاج تكا وسلمون مشوي. (Clean, fit, high-protein low-fat options specially tailored for high activity and peak fitness: Shish Tawook Salad, Chicken Tikka, and Seared Salmon.)',
        type: 'pre-made', dietType: 'paleo',
        meals: [meals[10]._id, meals[14]._id, meals[8]._id],
        basePrice: calcBoxPrice([meals[10], meals[14], meals[8]]),
        image: imgDietBasBox, isActive: true,
      },
    ]);
