...
const seed = async () => {
  try {
    ...
    const meals = await Meal.insertMany([
      {
        ...
        description: 'Traditional Egyptian street food. Layers of brown lentils, macaroni, fava rice, and chickpeas with vinegar garlic sauce and spicy tomato sauce.',
        ingredients: meal1Ings, dietType: 'vegetarian', cuisine: 'Egyptian',
        allergens: ['gluten'], image: imgKoshari,
        ...calcTotals(meal1Ings),
      },
      {
        name: 'Molokhia & Roasted Chicken',
        description: 'Authentic green soup cooked with garlic and coriander, served with juicy roasted chicken breast and white vermicelli rice.',
        ingredients: meal2Ings, dietType: 'standard', cuisine: 'Egyptian',
        allergens: [], image: imgMolokhia,
        ...calcTotals(meal2Ings),
      },
      {
        name: 'Egyptian Moussaka Casserole',
        description: 'Layers of tender baked eggplant, green bell peppers, and savory minced beef baked in a rich garlic tomato gravy.',
        ingredients: meal3Ings, dietType: 'standard', cuisine: 'Egyptian',
        allergens: [], image: imgMoussaka,
        ...calcTotals(meal3Ings),
      },
      {
        name: 'Alexandrian Falafel & Ful Mudammas',
        description: 'Fava bean falafel patties packed with fresh herbs, paired with slow-cooked fava beans in pure olive oil and cumin.',
        ingredients: meal4Ings, dietType: 'vegetarian', cuisine: 'Egyptian',
        allergens: ['eggs'], image: imgFalafel,
        ...calcTotals(meal4Ings),
      },
      {
        name: 'Egyptian Stuffed Veggies (Mahshi Zucchini)',
        description: 'Fresh local zucchini hollowed and stuffed with a seasoned rice, parsley, dill, and tomato herb mix.',
        ingredients: meal5Ings, dietType: 'vegetarian', cuisine: 'Egyptian',
        allergens: [], image: imgMahshi,
        ...calcTotals(meal5Ings),
      },
      {
        name: 'Egyptian Spiced Lentil Soup',
        description: 'Creamy and nourishing yellow lentil soup stewed with carrots, cumin, and garlic, served with crispy baladi bread.',
        ingredients: meal6Ings, dietType: 'vegetarian', cuisine: 'Egyptian',
        allergens: [], image: imgLentilSoup,
        ...calcTotals(meal6Ings),
      },
      {
        name: 'Baked Sea Bass Sayadeya',
        description: 'Fresh sea bass fillet baked Alexandrian-style with cumin, sweet peppers, and onions, over spiced caramelized Sayadeya rice.',
      ...
      },
      {
        ...
        description: 'Succulent shrimp sautéed in garlic-infused olive oil and butter, served over fresh spiralized zucchini noodles.',
        ingredients: meal8Ings, dietType: 'keto', cuisine: 'Mediterranean',
        allergens: ['shellfish'], image: imgShrimp,
        ...calcTotals(meal8Ings),
      },
      {
        name: 'Seared Salmon & Roasted Asparagus',
        description: 'Herb-encrusted salmon fillet seared with sea salt and served alongside fresh roasted baby asparagus.',
        ingredients: meal9Ings, dietType: 'keto', cuisine: 'Mediterranean',
        allergens: ['fish'], image: imgSalmon,
        ...calcTotals(meal9Ings),
      },
      {
        name: 'Charcoal-Grilled Beef Kofta',
        description: 'Juicy minced beef skewers seasoned with onions, parsley, and Middle Eastern spices, grilled and served with tahini sauce.',
        ingredients: meal10Ings, dietType: 'paleo', cuisine: 'Egyptian',
        allergens: [], image: imgKofta,
        ...calcTotals(meal10Ings),
      },
      {
        name: 'Shish Tawook Greens Salad',
        description: 'Marinated and grilled chicken skewers served over a colorful bed of crisp greens, cucumbers, and a olive oil lemon dressing.',
        ingredients: meal11Ings, dietType: 'paleo', cuisine: 'Egyptian',
        allergens: [], image: imgShishTawook,
        ...calcTotals(meal11Ings),
      },
      {
        name: 'Traditional Okra Stew (Bamya) with Lamb',
        description: 'Tender lamb chunks slow-cooked with fresh local baby okra in a savory garlic tomato sauce with a hint of fresh lemon.',
        ingredients: meal12Ings, dietType: 'standard', cuisine: 'Egyptian',
        allergens: [], image: imgBamya,
        ...calcTotals(meal12Ings),
      },
      {
        name: 'Spiced Chicken Shawarma Platter',
        description: 'Roasted chicken shawarma strips in garlic cardamom spices, served over healthy seasoned cauliflower rice.',
        ingredients: meal13Ings, dietType: 'keto', cuisine: 'Egyptian',
        allergens: [], image: imgShawarma,
        ...calcTotals(meal13Ings),
      },
      {
        name: 'Egyptian Shakshuka Eggs',
        description: 'Farm fresh eggs slow-poached in a simmering skillet of bell peppers, onions, chili, and garlic tomato stew with feta.',
        ingredients: meal14Ings, dietType: 'vegetarian', cuisine: 'Egyptian',
        allergens: ['eggs', 'dairy'], image: imgShakshuka,
        ...calcTotals(meal14Ings),
      },
      {
        name: 'Spiced Chicken Tikka & Saffron Rice',
        description: 'Spiced yogurt-marinated roasted chicken breast, served with premium aromatic saffron Basmati rice.',
        ingredients: meal15Ings, dietType: 'standard', cuisine: 'International',
        allergens: ['dairy'], image: imgChickenTikka,
        ...calcTotals(meal15Ings),
      },
      {
        name: 'Italian Spaghetti & Beef Meatballs',
        description: 'Spaghetti noodles tossed in rich tomato marinara, served with hand-rolled seasoned beef meatballs.',
        ingredients: meal16Ings, dietType: 'standard', cuisine: 'Italian',
        allergens: ['gluten'], image: imgPasta,
        ...calcTotals(meal16Ings),
      },
      {
        name: 'Mild Butter Chicken & Jasmine Rice',
        description: 'Boneless tender chicken simmered in a mildly sweet, rich tomato butter gravy, served with fluffy jasmine rice.',
    ...
    const boxes = await Box.insertMany([
      {
        name: 'البلدي يوكل (Baladi Box)',
        description: 'أشهر الأكلات المصرية الشعبية والأصيلة اللي بتدفي القلب: كشري وملوخية ومسقعة باللحمة المفرومة.',
      ...
      {
        name: 'علشان الدايت (Keto / Diet Box)',
        description: 'وجبات لذيذة وصحية وقليلة الكربوهيدرات عشان تحافظ على رشاقتك: كفتة مشوية وشاورما دجاج وشكشوكة غنية.',
      ...
      {
        name: 'أكل زمان (Zaman Veggie Box)',
        description: 'وجبات نباتية 100% مغذية ولذيذة بروح زمان وأكل الأمهات: طعمية وفول ومحشي كوسة وشوربة عدس دافية.',
      ...
      {
        name: 'أكلة بحري (Sayadeya & Seafood Box)',
        description: 'فسفور وطاقة من سواحل إسكندرية والبحر الأحمر: سمك قاروص صيادية وجمبري بالثوم والزبدة وسلمون مشوي.',
        type: 'pre-made', dietType: 'standard',
      ...
      {
        name: 'شغل عالي (Premium / Shoghl Ali Box)',
        description: 'تشكيلة فاخرة ولذيذة من أطباق الدجاج واللحم المميزة: شيش طاووق وبامية باللحم الضاني وتكا هندي بالزعفران.',
        type: 'pre-made', dietType: 'standard',
      ...
      {
        name: 'لمة العيلة (Family Gathering / Balanced Box)',
        description: 'وجبات متوازنة ومحبوبة للأطفال والكبار بتكفي كل العيلة: مكرونة بالكرات واللحم وبتر تشيكن هندي وشيكن بول كلاسيك.',
        type: 'pre-made', dietType: 'standard',
