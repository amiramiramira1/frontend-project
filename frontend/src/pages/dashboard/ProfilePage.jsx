...
export default function ProfilePage() {
  ...
  const addAddress = () => {
    if (!newAddr.street || !newAddr.phone) {
      toast.error('Street and phone required');
      return;
    }

    setAddresses((prev) => [
      ...prev,
      { ...newAddr, _id: Date.now().toString() },
    ]);
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="btn-outline !py-1.5 !px-4 text-sm flex items-center gap-1.5"
          >
        ...
        {showAddForm && (
          <div className="bg-gray-50 rounded-xl p-4 mb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <button onClick={addAddress} className="btn-primary text-sm">
              Add Address
            </button>
          </div>
        )}
...
<div className="mt-10 card border border-red-100 p-6">
  ...
  <div className="flex items-start justify-between gap-4">
    ...
    <button
      ...
      className="px-4 py-2 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 font-medium transition"
    >
      Delete Account
    </button>
  </div>
  ...
  {showDelete && (
    <div className="mt-6 border-t pt-5 space-y-4">
      ...
      <p className="text-sm text-gray-600">
        Type <b className="text-black">DELETE</b> to confirm:
      </p>
