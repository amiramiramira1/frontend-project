 ...
 * @property {string} fullName - Full name for delivery
 * @property {string} phone - Contact phone number
 * @property {string} address - Delivery address
 * @property {string} city - City name
 * @property {string} postalCode - Postal/ZIP code
 * @property {boolean} saveAsDefault - Whether to save as default address
 * @property {string|null} selectedAddressId - ID of the selected saved address
 */

/**
 * @typedef {Object} DeliveryAddressFormProps
 * @property {DeliveryInfo} deliveryInfo - Delivery information object
 * @property {Function} onChange - Handler for form field changes
 * @property {Function} onSelectSavedAddress - Handler for selecting a saved address
 * @property {boolean} showNewAddressForm - Whether to show the new address form
 * @property {Function} onToggleNewAddress - Toggle function for new address form
 */

/**
 * DeliveryAddressForm component for handling delivery address input
 * @param {DeliveryAddressFormProps} props - Component props
 */
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2 pt-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => onChange('saveAsDefault', Boolean(checked))}
              />
