...
// Form props for payment method selection
// paymentMethod: string - currently selected payment method
// onChange: function - callback when payment method changes

const PaymentMethodForm = ({ paymentMethod, onChange }) => {
  return (
    <Card>
      <CardHeader>
