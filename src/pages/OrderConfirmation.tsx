...
const timelineSteps = [
  { label: 'Order Confirmed', icon: CheckCircle2, status: 'done' as const },
  { label: 'Preparing Your Box', icon: ChefHat, status: 'current' as const },
  { label: 'Out for Delivery', icon: Truck, status: 'upcoming' as const },
  { label: 'Delivered', icon: Package, status: 'upcoming' as const },
];
