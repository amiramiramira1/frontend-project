 ...
 * @property {string} name - Display name of the box
 ...
 * @property {string} image - Path to the box image
 * @property {string|null} tag - Optional tag (e.g., 'New', 'Popular')
 * @property {string[]} dietType - Array of diet types
 * @property {number} mealsPerWeek - Number of meals per week
 * @property {Object} nutrition - Nutrition information
 * @property {number} nutrition.calories - Calories per serving
 * @property {number} nutrition.protein - Protein in grams
 * @property {number} nutrition.carbs - Carbohydrates in grams
 * @property {number} nutrition.fat - Fat in grams
 * @property {Array} meals - Array of meal objects
 * @property {Array} customerReviews - Array of customer reviews
 * @property {number} customerReviews.id - Review ID
 * @property {string} customerReviews.name - Reviewer name
 * @property {number} customerReviews.rating - Rating (1-5)
 * @property {string} customerReviews.date - Review date
 * @property {string} customerReviews.comment - Review text
 * @property {string} customerReviews.avatar - URL to reviewer's avatar
 */
